...
@ManagedBean(name = "PojmoviSlagalicaBean")
@SessionScoped
public class PojmoviSlagalicaBean {
    ...
    public String proveri() {
        ...
        if (tacnoOne == true) {
            ...
            if (g == null) {    //ne postoji u gramatici
                ...
                bodovi = 0;
                sesija.setAttribute("bodovi", bodovi);
                sesija.setAttribute("igraSlagalica", bodovi);
                ...
                sesija.setAttribute("zavrseno", 1);
                return "/igraMojbroj/igraDanaMojbroj.xhtml?faces-redirect=true";
            }
        } else {
        ...
        if (tacnoOne == true && tacnoTwo == false) {
            ...
            int br = rec.length();
            br *= 2;
            sesija.setAttribute("moguciBodovi", br);
            sesija.setAttribute("bodovi", bodovi);
            sesija.setAttribute("igraSlagalica", bodovi);
            sesija.setAttribute("zavrseno", 0);
            ...
            return "cekamSupervizora.xhtml?faces-redirect=true";
        }
        return "/igraMojbroj/igraDanaMojbroj.xhtml?faces-redirect=true";
    }
