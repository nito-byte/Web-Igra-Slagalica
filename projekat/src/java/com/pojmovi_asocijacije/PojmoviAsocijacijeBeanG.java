...
@ManagedBean(name = "PojmoviAsocijacijeBeanG")
@SessionScoped
public class PojmoviAsocijacijeBeanG {
...
//    }
    ...
    public String cadastrarSinonimiG() {

        for (Word item : words) {
            SinonimiGDAO inserir = new SinonimiGDAOImpl();
            SinonimiG usuario = new SinonimiG();
            usuario.setKolonaG(item.getRec());
