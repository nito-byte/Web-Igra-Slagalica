...
@ManagedBean(name = "MojBrojBean")
@SessionScoped
public class MojBrojBean {
...
//        }
        ...
        for (int j = 10; j < 11; j++) {  //zabranim da je ispred zagrade broj, mora operand pa zagrada
            znaci.add(j, "none");
        }
    }
